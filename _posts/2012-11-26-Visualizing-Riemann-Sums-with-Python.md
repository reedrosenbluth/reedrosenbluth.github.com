...
First use numpy's *arange* routine to create a list of numbers from a to b, with an interval of .02. Then, we set y equal to the set of outputs from our function f, which we use to plot our function.
